...
# FloodGuard Penang — Predictions Page

**Route:** `/predictions`

## 1. Purpose

Compare current FloodGuard flood-risk predictions across supported monitoring stations.
...
### Prediction summary — approximately 6 columns

Three compact summary blocks:
...
- station count
- percentage of monitored stations

Use restrained semantic tints.

### Prediction guide — approximately 3 columns
...
### Prediction freshness — approximately 3 columns
...
## 4. Main prediction table — approximately 9 columns
...
- compact value / risk treatment
- consistent color scale
- no official JPS terminology unless explicitly comparing to an official threshold

Do not show prediction values for stale/invalid input when backend marks prediction unavailable.

## 5. Right rail — approximately 3 columns

### Top stations by predicted risk

Ranked list of highest current model risk.
...
Keep a visible note that FloodGuard predictions are model outputs and not official JPS warnings.
