...
# FloodGuard Penang — Alerts Page

**Route:** `/alerts`

## 1. Purpose

Review active and historical flood-condition, prediction, data-quality and system alerts.

## 2. Header

- `Alerts`
- subtitle: `Flood conditions and data-quality alerts`
- Last updated
- Refresh
- time range selector

## 3. Alert summary strip
...
### Alerts table/list — approximately 8 columns
...
Selected row receives subtle blue outline/background.

### Alert detail panel — approximately 4 columns

Selected alert displays:
...
- district
- alert category
- factual alert message
- observed value
- relevant official threshold
- station information
- source
...
- View on map
- or Open station detail

## 5. Bottom legend

Explain alert categories:
...
- JPS official threshold alerts
- FloodGuard prediction alerts
- data-quality alerts
- system alerts

Do not add acknowledge, assign, snooze or manual resolve actions unless backend support exists.
